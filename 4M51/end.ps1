# Advanced obfuscation to evade static detection - FIXED VERSION
$randomSeed = Get-Random -Minimum 100000 -Maximum 999999
$b64String = [System.Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes($randomSeed.ToString())).Replace("=","")
$namespace = "N" + $b64String.Substring(0, [Math]::Min($b64String.Length, 8))
